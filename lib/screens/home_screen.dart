        ...
        _buildBasicsCard(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const KanaLearningScreen(isKatakana: false),
              ),
            );
          },
        ),
        _buildBasicsCard(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const KanaLearningScreen(isKatakana: true),
              ),
            );
          },
        ),
              ...
              onTap: () {
                ...
                if (isFlashcard) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const QuizScreen(level: 'N5'),
                    ),
                  );
                }
              },
              ...
              onTap: () {
                ...
                if (isFlashcard) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const QuizScreen(level: 'N4'),
                    ),
                  );
                }
              },
              ...
              onTap: () {
                ...
                if (isFlashcard) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const QuizScreen(level: 'N3'),
                    ),
                  );
                }
              },
